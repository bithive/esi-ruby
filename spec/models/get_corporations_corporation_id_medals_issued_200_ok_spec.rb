...
# Unit tests for EsiRuby::GetCorporationsCorporationIdMedalsIssued200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdMedalsIssued200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdMedalsIssued200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdMedalsIssued200Ok)
    end
  end
