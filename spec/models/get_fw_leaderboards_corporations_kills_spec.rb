...
# Unit tests for EsiRuby::GetFwLeaderboardsCorporationsKills
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCorporationsKills' do
  before do
    # run before each test
    @instance = EsiRuby::GetFwLeaderboardsCorporationsKills.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCorporationsKills' do
    it 'should create an instance of GetFwLeaderboardsCorporationsKills' do
      expect(@instance).to be_instance_of(EsiRuby::GetFwLeaderboardsCorporationsKills)
    end
  end
