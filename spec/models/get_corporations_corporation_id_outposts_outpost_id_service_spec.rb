...
# Unit tests for EsiRuby::GetCorporationsCorporationIdOutpostsOutpostIdService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdOutpostsOutpostIdService' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdOutpostsOutpostIdService.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdOutpostsOutpostIdService' do
    it 'should create an instance of GetCorporationsCorporationIdOutpostsOutpostIdService' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdOutpostsOutpostIdService)
    end
  end
