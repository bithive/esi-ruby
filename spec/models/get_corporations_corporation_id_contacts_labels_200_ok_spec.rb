...
# Unit tests for EsiRuby::GetCorporationsCorporationIdContactsLabels200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdContactsLabels200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdContactsLabels200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdContactsLabels200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdContactsLabels200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdContactsLabels200Ok)
    end
  end
